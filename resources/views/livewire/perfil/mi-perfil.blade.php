                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="card border-0 shadow-sm p-3 h-100">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" wire:model="nuevo_nombre">
                                            <button class="btn btn-outline-primary" wire:click="enviarSolicitud('nombre')">Solicitar</button>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="col-md-6">
                                    <div class="card border-0 shadow-sm p-3 h-100">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" wire:model="nuevo_username">
                                            <button class="btn btn-outline-primary" wire:click="enviarSolicitud('username')">Solicitar</button>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="col-md-12">
                                    <div class="card border-0 shadow-sm p-3">
                                        ...
                                        <div class="input-group">
                                            <input type="email" class="form-control" wire:model="nuevo_email">
                                            <button class="btn btn-outline-primary" wire:click="enviarSolicitud('email')">Solicitar</button>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="col-12 mt-4">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <input type="password" class="form-control shadow-sm" placeholder="Nueva Contraseña" wire:model="nuevo_password">
                                        </div>
                                        <div class="col-md-4">
                                            <input type="password" class="form-control shadow-sm" placeholder="Repite Contraseña" wire:model="confirmar_password">
                                        </div>
                                        <div class="col-md-2">
                                            <button class="btn btn-dark w-100 shadow-sm" wire:click="enviarSolicitud('password')">Cambiar</button>
                                        </div>
                                    </div>
