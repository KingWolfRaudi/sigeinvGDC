    ...
    <div class="row mb-4 align-items-center">
        <div class="col-12 d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h2 class="fw-bold mb-0 text-body">Catálogo de Tipos de Dispositivo</h2>
                    <p class="text-muted mb-0">Clasificación de activos según su propósito y categoría de hardware.</p>
                </div>
            </div>
            <div class="text-end">
                <div class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 px-3 py-2 rounded-pill shadow-sm">
                    <i class="bi bi-collection me-1"></i> Total Tipos: <span class="fw-bold fs-6 ms-1">{{ $tipos->total() }}</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4 text-end d-flex gap-2 justify-content-end">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu shadow border-0">
                            <li><a class="dropdown-item py-2" href="{{ route('reportes.catalogo.excel', ['tipo' => 'tipos', 'search' => $search, 'estado' => $filtro_estado]) }}"><i class="bi bi-filter me-2 text-success"></i> Vista Actual</a></li>
                            <li><a class="dropdown-item py-2" href="{{ route('reportes.catalogo.excel', ['tipo' => 'tipos']) }}"><i class="bi bi-list-check me-2 text-primary"></i> Todo el Catálogo</a></li>
                        </ul>
                    </div>
                    @endcan
