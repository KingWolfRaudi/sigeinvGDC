<div>
    <div class="row mb-4 align-items-center">
        <div class="col-md-5">
            <h3 class="mb-0">Catálogo de Sistemas Operativos</h3>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-3 text-end d-flex gap-2">
            <div class="dropdown w-100">
                ...
                <ul class="dropdown-menu shadow border-0">
                    <li>
                        <a class="dropdown-item py-2" href="{{ route('reportes.catalogo.excel', ['tipo' => 'so', 'search' => $search, 'estado' => $filtro_estado]) }}">
                            <i class="bi bi-filter me-2 text-success"></i> Vista Actual
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item py-2" href="{{ route('reportes.catalogo.excel', ['tipo' => 'so']) }}">
                ...
                <div class="modal-body">
                    @if($sistema_detalle)
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><strong>ID:</strong> {{ $sistema_detalle->id }}</li>
                            ...
                            <li class="list-group-item"><strong>Creado el:</strong> {{ $sistema_detalle->created_at->format('d/m/Y H:i') }}</li>
                        </ul>
                    @endif
                </div>
                <div class="modal-footer d-flex justify-content-between">
                    @if($sistema_detalle)
                        <a href="{{ route('asociaciones', ['tipo' => 'so', 'id' => $sistema_detalle->id]) }}" class="btn btn-outline-primary shadow-sm">
