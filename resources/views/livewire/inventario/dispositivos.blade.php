                        ...
                        <tr>
                            <td>
                                ...
                                @if($disp->pendientes_count > 0)
                                    <a href="{{ route('movimientos.dispositivos') }}" class="badge bg-warning text-dark px-1 py-0 shadow-sm deco-none" title="Tiene {{ $disp->pendientes_count }} cambio(s) pendiente(s) por aprobar">
