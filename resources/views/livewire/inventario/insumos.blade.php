        ...
        <div class="col-12 d-flex align-items-center justify-content-between">
            ...
            <div class="text-end">
                <div class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 px-3 py-2 rounded-pill shadow-sm">
                    <i class="bi bi-collection me-1"></i> Total Insumos: <span class="fw-bold fs-6 ms-1">{{ $insumos->total() }}</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4 text-end d-flex gap-2 justify-content-end">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu shadow border-0">
                            <li><a class="dropdown-item py-2" href="{{ route('reportes.inventario.insumos.excel', ['search' => $search, 'estado' => $filtro_estado]) }}"><i class="bi bi-filter me-2 text-success"></i> Vista Actual</a></li>
                            <li><a class="dropdown-item py-2" href="{{ route('reportes.inventario.insumos.excel') }}"><i class="bi bi-list-check me-2 text-primary"></i> Todo el Inventario</a></li>
                        </ul>
                    </div>
                    @endcan
                    @can('crear-insumos')
