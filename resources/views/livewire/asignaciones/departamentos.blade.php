<div>
    <div class="row mb-4 align-items-center">
        <div class="col-md-5">
            <h3 class="mb-0"><i class="bi bi-building me-2"></i>Catálogo de Departamentos</h3>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-3 text-end d-flex gap-2">
            ...
            <div class="dropdown w-100">
                ...
                <ul class="dropdown-menu shadow border-0">
                    <li>
                        <a class="dropdown-item py-2" href="{{ route('reportes.catalogo.excel', ['tipo' => 'departamentos', 'search' => $search, 'estado' => $filtro_estado]) }}">
                            <i class="bi bi-filter me-2 text-success"></i> Vista Actual
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item py-2" href="{{ route('reportes.catalogo.excel', ['tipo' => 'departamentos']) }}">
