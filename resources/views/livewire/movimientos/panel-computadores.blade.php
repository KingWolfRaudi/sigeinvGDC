                ...
                <div class="col-md-4 text-end d-flex gap-2 justify-content-end">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu shadow border-0">
                            <li><a class="dropdown-item py-2" href="{{ route('reportes.movimientos.excel', ['segmento' => 'computadores', 'search' => $search, 'tipo_operacion' => $filtro_tipo]) }}"><i class="bi bi-filter me-2 text-success"></i> Vista Actual</a></li>
                            <li><a class="dropdown-item py-2" href="{{ route('reportes.movimientos.excel', ['segmento' => 'computadores']) }}"><i class="bi bi-list-check me-2 text-primary"></i> Todo el Historial</a></li>
                        </ul>
                    </div>
                    @endcan
