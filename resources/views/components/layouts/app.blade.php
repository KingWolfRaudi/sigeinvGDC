...
<body class="bg-body-tertiary">
    ...
    @auth
        <div class="d-flex vh-100 overflow-hidden">
            ...
            <div id="sidebarMenu" class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark shadow-sm"
                style="width: 280px; z-index: 1000;">
                <a href="{{ route('perfil') }}"
                    class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none px-2 py-1 rounded hover-bg-body-secondary">
                    <div class="me-2">
                        @if(Auth::user()->avatar)
                ...
                <ul class="nav nav-pills flex-column mb-auto overflow-y-auto flex-nowrap w-100" id="menuLateral"
                    style="overflow-x: hidden;">

                    @can('ver-dashboard')
                    <li class="nav-item mb-1">
                        <a href="{{ route('dashboard') }}"
                            class="nav-link {{ request()->routeIs('dashboard') ? 'active' : 'text-white' }} d-flex align-items-center">
                    ...
                    @canany(['ver-marcas', 'ver-tipos-dispositivo', 'ver-sistemas-operativos', 'ver-puertos', 'ver-procesadores', 'ver-gpus'])
                        <li class="nav-item mb-1">
                            <a href="#submenuCatalogos" data-bs-toggle="collapse"
                                aria-expanded="{{ request()->routeIs('catalogos.*') ? 'true' : 'false' }}"
                                class="nav-link {{ request()->routeIs('catalogos.*') ? 'active' : 'text-white' }} d-flex justify-content-between align-items-center">
                                <div><i class="bi bi-folder me-2"></i> Catálogos</div>
                                <i class="bi bi-chevron-down" style="font-size: 0.8rem;"></i>
                            </a>
                            <div class="collapse {{ request()->routeIs('catalogos.*') ? 'show' : '' }}" id="submenuCatalogos"
                                data-bs-parent="#menuLateral">
                                <ul class="nav flex-column ms-3 mt-1" style="border-left: 1px solid rgba(255,255,255,0.1);">
                                    @can('ver-marcas')
                                        <li class="nav-item">
                                            <a href="{{ route('catalogos.marcas') }}"
                                                class="nav-link {{ request()->routeIs('catalogos.marcas') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('ver-tipos-dispositivo')
                                        <li class="nav-item">
                                            <a href="{{ route('catalogos.tipos-dispositivo') }}"
                                                class="nav-link {{ request()->routeIs('catalogos.tipos-dispositivo') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('ver-sistemas-operativos')
                                        <li class="nav-item">
                                            <a href="{{ route('catalogos.sistemas-operativos') }}"
                                                class="nav-link {{ request()->routeIs('catalogos.sistemas-operativos') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('ver-puertos')
                                        <li class="nav-item">
                                            <a href="{{ route('catalogos.puertos') }}"
                                                class="nav-link {{ request()->routeIs('catalogos.puertos') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('ver-procesadores')
                                        <li class="nav-item">
                                            <a href="{{ route('catalogos.procesadores') }}"
                                                class="nav-link {{ request()->routeIs('catalogos.procesadores') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('ver-gpus')
                                        <li class="nav-item">
                                            <a href="{{ route('catalogos.gpus') }}"
                                                class="nav-link {{ request()->routeIs('catalogos.gpus') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                    ...
                    @canany(['ver-trabajadores', 'ver-departamentos'])
                        <li class="nav-item mb-1">
                            <a href="#submenuAsignaciones" data-bs-toggle="collapse"
                                aria-expanded="{{ request()->routeIs('asignaciones.*') ? 'true' : 'false' }}"
                                class="nav-link {{ request()->routeIs('asignaciones.*') ? 'active' : 'text-white' }} d-flex justify-content-between align-items-center">
                                <div><i class="bi bi-card-checklist me-2"></i> Asignaciones</div>
                                <i class="bi bi-chevron-down" style="font-size: 0.8rem;"></i>
                            </a>
                            <div class="collapse {{ request()->routeIs('asignaciones.*') ? 'show' : '' }}"
                                id="submenuAsignaciones" data-bs-parent="#menuLateral">
                                <ul class="nav flex-column ms-3 mt-1" style="border-left: 1px solid rgba(255,255,255,0.1);">
                                    @can('ver-trabajadores')
                                        <li class="nav-item">
                                            <a href="{{ route('asignaciones.trabajadores') }}"
                                                class="nav-link {{ request()->routeIs('asignaciones.trabajadores') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('ver-departamentos')
                                        <li class="nav-item">
                                            <a href="{{ route('asignaciones.departamentos') }}"
                                                class="nav-link {{ request()->routeIs('asignaciones.departamentos') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                                <i class="bi bi-building me-2"></i> Departamentos
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('asignaciones.dependencias') }}"
                                                class="nav-link {{ request()->routeIs('asignaciones.dependencias') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                    ...
                    @canany(['ver-computadores', 'ver-dispositivos', 'ver-insumos', 'ver-software'])
                        <li class="nav-item mb-1">
                            <a href="#submenuInventario" data-bs-toggle="collapse"
                                aria-expanded="{{ request()->routeIs('inventario.*') ? 'true' : 'false' }}"
                                class="nav-link {{ request()->routeIs('inventario.*') ? 'active' : 'text-white' }} d-flex justify-content-between align-items-center">
                                <div><i class="bi bi-box-seam me-2"></i> Inventario</div>
                                <i class="bi bi-chevron-down" style="font-size: 0.8rem;"></i>
                            </a>
                            <div class="collapse {{ request()->routeIs('inventario.*') ? 'show' : '' }}" id="submenuInventario"
                                data-bs-parent="#menuLateral">
                                <ul class="nav flex-column ms-3 mt-1" style="border-left: 1px solid rgba(255,255,255,0.1);">
                                    @can('ver-computadores')
                                        <li class="nav-item">
                                            <a href="{{ route('inventario.computadores') }}"
                                                class="nav-link {{ request()->routeIs('inventario.computadores') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('ver-dispositivos')
                                        <li class="nav-item">
                                            <a href="{{ route('inventario.dispositivos') }}"
                                                class="nav-link {{ request()->routeIs('inventario.dispositivos') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('ver-insumos')
                                        <li class="nav-item">
                                            <a href="{{ route('inventario.insumos') }}"
                                                class="nav-link {{ request()->routeIs('inventario.insumos') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('ver-software')
                                        <li class="nav-item">
                                            <a href="{{ route('inventario.software') }}"
                                                class="nav-link {{ request()->routeIs('inventario.software') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                    ...
                    @canany(['ver-incidencias', 'crear-ticket'])
                        ...
                        <li class="nav-item mb-1">
                            <a class="nav-link text-white d-flex align-items-center justify-content-between {{ request()->routeIs('incidencias.*') ? 'active' : '' }}"
                                data-bs-toggle="collapse" href="#collapseIncidencias" role="button"
                                aria-expanded="{{ request()->routeIs('incidencias.*') ? 'true' : 'false' }}">
                                <span><i class="bi bi-exclamation-triangle me-2"></i>Panel de Soporte</span>
                                <i class="bi bi-chevron-down small"></i>
                            </a>
                            <div class="collapse {{ request()->routeIs('incidencias.*') ? 'show' : '' }}"
                                id="collapseIncidencias">
                                <ul class="nav flex-column ms-3 border-start border-secondary ps-2">
                                    @can('crear-ticket')
                                        <li class="nav-item">
                                            <a href="{{ route('incidencias.crear') }}"
                                                class="nav-link {{ request()->routeIs('incidencias.crear') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('ver-incidencias')
                                        <li class="nav-item">
                                            <a href="{{ route('incidencias.gestion') }}"
                                                class="nav-link {{ request()->routeIs('incidencias.gestion') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                    ...
                    @canany(['movimientos-computadores-ver', 'movimientos-dispositivos-ver', 'movimientos-insumos-ver'])
                        ...
                        <li class="nav-item mb-1">
                            ...
                            <div class="collapse {{ request()->routeIs('movimientos.*') ? 'show' : '' }}"
                                id="collapseMovimientos">
                                <ul class="nav flex-column ms-3 border-start border-secondary ps-2">
                                    @can('movimientos-computadores-ver')
                                        <li class="nav-item">
                                            <a href="{{ route('movimientos.computadores') }}"
                                                class="nav-link {{ request()->routeIs('movimientos.computadores') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                                <i class="bi bi-pc-display me-2"></i> Computadores
                                            </a>
                                        </li>
                                    @endcan
                                    @can('movimientos-dispositivos-ver')
                                        <li class="nav-item">
                                            <a href="{{ route('movimientos.dispositivos') }}"
                                                class="nav-link {{ request()->routeIs('movimientos.dispositivos') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                                <i class="bi bi-router me-2"></i> Dispositivos
                                            </a>
                                        </li>
                                    @endcan
                                    @can('movimientos-insumos-ver')
                                        <li class="nav-item">
                                            <a href="{{ route('movimientos.insumos') }}"
                                                class="nav-link {{ request()->routeIs('movimientos.insumos') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                                    ...
                                    @can('admin-solicitudes-perfil')
                                        <li class="nav-item">
                                            <a href="{{ route('movimientos.solicitudes-perfil') }}"
                                                class="nav-link {{ request()->routeIs('movimientos.solicitudes-perfil') ? 'text-white' : 'text-white-50' }} px-3 py-1 text-sm d-flex align-items-center">
                    ...
                    @can('ver-roles')
                        <li class="nav-item mb-1">
                            <a href="{{ route('admin.roles') }}"
                                class="nav-link {{ request()->routeIs('admin.roles') ? 'active' : 'text-white' }} d-flex align-items-center">
                    ...
                    @canany(['admin-incidencias', 'admin-solicitudes-perfil'])
                        <li class="nav-item mb-1">
                            <a href="{{ route('admin.configuracion') }}"
                                class="nav-link {{ request()->routeIs('admin.configuracion') ? 'active' : 'text-white' }} d-flex align-items-center">
                    ...
                    @can('ver-usuarios')
                        <li class="nav-item mb-1">
                            <a href="{{ route('admin.usuarios') }}"
                                class="nav-link {{ request()->routeIs('admin.usuarios') ? 'active' : 'text-white' }} d-flex align-items-center">
                    ...
                    @can('admin-auditoria')
                        <li class="nav-item mb-1">
                            <a href="{{ route('admin.auditoria') }}"
                                class="nav-link {{ request()->routeIs('admin.auditoria') ? 'active' : 'text-white' }} d-flex align-items-center">
                    ...
                    @can('ver-auditoria-tecnicos')
                        <li class="nav-item mb-1">
                            <a href="{{ route('admin.auditoria-tecnicos') }}"
                                class="nav-link {{ request()->routeIs('admin.auditoria-tecnicos') ? 'active' : 'text-white' }} d-flex align-items-center">
                                <i class="bi bi-journal-check me-2"></i> Auditoría de Técnicos
                            </a>
                        </li>
                    @endcan
                    ...
                    @can('ver-auditoria-usuarios')
                        <li class="nav-item mb-1">
                            <a href="{{ route('admin.auditoria-usuarios') }}"
                                class="nav-link {{ request()->routeIs('admin.auditoria-usuarios') ? 'active' : 'text-white' }} d-flex align-items-center">
                ...
                <div class="dropdown px-2">
                    <a href="#"
                        class="d-flex align-items-center text-white text-decoration-none dropdown-toggle p-2 rounded hover-bg-body-secondary"
                        id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false" style="min-width: 0;">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser">
                        <li><a class="dropdown-item" href="{{ route('perfil') }}"><i class="bi bi-person me-2"></i>Mi
                                Perfil</a></li>
                        <li>
